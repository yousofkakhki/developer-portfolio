...
function ContactForm() {
  ...
  const inputClassName = (field) => `brand-field w-full px-3 py-2 focus:outline-none transition-colors ${
  ...
  return (
    <section id="contact" className="brand-section">
      <div className="mx-auto max-w-5xl">
        <h2 className="brand-section__title mb-4 text-3xl font-semibold text-slate-100">{t('title')}</h2>
